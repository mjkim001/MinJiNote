...
public class FileTest01 {
	public static void main(String[] args) {
		...
		//  ==> 파일 또는 경로를 나타낼 때 디렉토리와 디렉토리 사이 또는
		//		디렉토리의 파일명 사이의 구분 문자를 '/'를 사용하거나
		//		'\'를 사용할 수 있다.
		
		//File file = new File("D:/D_other/text.txt"); //구분문자로 '/'사용
		...
		//디렉토리(폴더) 만들기
		/*
		 * mkdir() ==> file객체의 경로중에서 마지막 위치와 디렉토리를 생성한다.
		 *   반환값 => 만들기 성공 : true, 만들기 실패 : false
		 *   ==> 증간부분의 경로가 모두 만들어져 있어야 마지막 위치의 경로를 
		 *   	 만들수 있다.
		 * mkdirs() ==> 증간부분의 경로가
		 */
