...
public class TcpServer01 {
	public static void main(String[] args) throws IOException {
		//TCP 소켓 통신을 하기 위해 ServerSoket객체를 생성
		ServerSocket server  = new ServerSocket(77777);
		
		System.out.println("접속을 기다립니다...");
		
		//accept()메서드
		// ==> 클라이언트의 연결 요청이 올때까지 계속 기다린다.
		// ==> 연결 요청이 오면 새로운 Socket객체를 생성해서
		//	   클라이언트와 Socket과 연결하여 반환한다.
		...
		System.out.println("Port주소 : "+ socket.getPort());
		System.out.println();
		...
		//클라이언트에게 메시지 보내기
		//socket의 OutputStream 객체를 구성해서 전송한다.
